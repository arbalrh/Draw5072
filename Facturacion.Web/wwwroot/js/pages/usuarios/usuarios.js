let usuarios = (function (window, undefined) {
    let st = {
...
const appUsuarios = new Vue({
    ...
    data: {
        ...
        url: '',
        urlcreateusuario: '',
        formValidationUsuario: {
            correoRequerido: false,
            contraseñaRequerido: false
        },
        formUsuario: {
            email: '',
            password: '',
        ...
        resources: {
            ...
            deleteMensajeUsuario: '¿Está seguro de que desea eliminar este Usuario?',
        }
    },
    methods: {
        ...
        createUsuario() {
            this.resetValidationCreateForm();
            if (!this.formUsuario.email) {
                this.formValidationUsuario.correoRequerido = true;
                return;
            }
            if (!this.formUsuario.password) {
                this.formValidationUsuario.contraseñaRequerido = true;
                return;
            }
            $('#modal-register').modal('hide');
            InitApp.showLoading();
            axios
                .post(this.urlcreateusuario, this.formUsuario, {
                    headers: {
        ...
        resetValidationCreateForm() {
            this.formValidationUsuario.correoRequerido = false;
            this.formValidationUsuario.contraseñaRequerido = false;
        }
    },
    computed: {
    },
    beforeMount: function () {
        ...
        this.urlcreateusuario = `${this.basePath}Account/Register`;
    },
    mounted: function () {
    }
});